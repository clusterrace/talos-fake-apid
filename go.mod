module github.com/clusterrace/talos-fake-apid

go 1.24.3

require (
	github.com/cosi-project/runtime v1.10.7
	github.com/siderolabs/talos/pkg/machinery v0.0.0
...
replace github.com/siderolabs/talos/pkg/machinery => /home/susverwimp/siderolabs/talos/pkg/machinery
